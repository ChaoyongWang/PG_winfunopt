...
extern void opt_tuplestore_copy_frameheadptr(Tuplestorestate *state);
extern void opt_tuplestore_update_frameheadptr(Tuplestorestate *state, int64 distance);
extern void opt_tuplestore_init_frameheadptr(Tuplestorestate *state);
extern void opt_tuplestore_copy_ptr(Tuplestorestate *state, int dst, int src);
extern void	opt_tuplestore_seek_ptr(Tuplestorestate *state, int ptr);
extern void opt_tuplestore_tell_ptr(Tuplestorestate *state, int ptr);
extern void reuse_tuplestore_puttuple(Tuplestorestate *state, void *tuple, int64 pos);
extern void reuse_tuplestore_trim(Tuplestorestate *state, int64 frameheadpos);
extern bool reuse_tuplestore_gettupleslot_direct(Tuplestorestate *state, int64 pos, TupleTableSlot *slot);
extern bool reuse_tuplestore_gettupleslot(Tuplestorestate *state, bool forward, bool copy, TupleTableSlot *slot, int64 pos);
extern void reuse_tuplestore_clear(Tuplestorestate *state);
extern bool reuse_tuplestore_has_reuseptr(Tuplestorestate *state);
extern int64 reuse_tuplestore_copy_reuseptr(Tuplestorestate *state);
