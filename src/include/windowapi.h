...
//#ifdef WIN_FUN_OPT
extern bool opt_WinRowsArePeers(WindowObject winobj, int64 pos1, int64 pos2);
extern void opt_update_frameheadptr(WindowObject winobj, int64 frameheadpos);
extern void opt_copy_frameheadptr(WindowObject winobj);
extern void opt_copy_tempTransEndPtr(WindowObject winobj, int target);
extern void copy_reuseptr(WindowObject winobj);
//#endif

/* add by cywang */
extern bool enable_winfunopt;
extern bool enable_locate;
extern bool	enable_recompute;
extern bool enable_reusebuffer;
extern int	recompute_k;
extern int	recompute_num;
