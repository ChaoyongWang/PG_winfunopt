...
static struct config_bool ConfigureNamesBool[] =
{
	...
	{
		{"enable_winfunopt", PGC_USERSET, QUERY_TUNING_METHOD,
			gettext_noop("Enables the executor's use of window function optimization."),
			NULL
		},
		&enable_winfunopt,
		false,
	...
	{
		{"enable_locate", PGC_USERSET, QUERY_TUNING_METHOD,
			gettext_noop("Enables the executor's use of window function to locate the frame head position efficiently."),
			NULL
		},
		&enable_locate,
		true,
	...
	{
		{"enable_recompute", PGC_USERSET, QUERY_TUNING_METHOD,
			gettext_noop("Enables the executor's use of window function optimization about reducing recompute."),
			NULL
		},
		&enable_recompute,
		true,
	...
	{
		{"enable_reusebuffer", PGC_USERSET, QUERY_TUNING_METHOD,
			gettext_noop("Enables the executor's use of window function optimization about reusing buffer."),
			NULL
		},
		&enable_reusebuffer,
		false,
...
{
	{
		{"recompute_k", PGC_USERSET, QUERY_TUNING_METHOD,
			gettext_noop("Set the parameter k of recompute. "),
			NULL
		},
		&recompute_k,
		100, 5, 5000,
	...
	{
		{"recompute_num", PGC_USERSET, QUERY_TUNING_METHOD,
			gettext_noop("Set the number of temporary transition value for recompute. "),
			NULL
		},
		&recompute_num,
		1, 0, 16,
